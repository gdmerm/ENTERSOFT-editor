 ...
 var ESImageEditPlugin = (function (RD, $) {
        ...
        this.propertiesTemplate = 
            '<div class="clearfix">' +
                ...
                '<div class="redactor-esimageedit-preview-pane">' +
                    '<figure><div><span id="preview-width">0</span>x<span id="preview-height">0</span></div><img id="redactor-esimageedit-preview-img" src="{{imageSource}}" /></figure>' +
    ...
    ESImageEdit.prototype = {
        ...
        bindPropertiesToView: function($modal) {
            ...
            $modal.find('#redactor-esimageedit-preview-img').attr('src', imgProps.src);
